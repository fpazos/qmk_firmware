...
[_QWERTY] = LAYOUT_ortho_5x12(
  ...
  KC_LCTL, KC_LGUI, KC_LALT, KC_NUBS, LT(_LOWER, KC_SPC),   KC_BSPC,  KC_SPC,  LT(_RAISE, KC_BSPC), KC_RALT, KC_RGUI, KC_RGHT, KC_LCTL
),
...
[_GAME] = LAYOUT_ortho_5x12(
  ...
  KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MT(MOD_LSFT,KC_ENT),
  KC_LCTL, KC_LGUI, KC_LALT, KC_GRV, LT(_LOWER, KC_BSPC),  KC_SPC,  KC_SPC,  LT(_RAISE, KC_BSPC), KC_RALT, KC_RGUI, KC_RGHT, KC_RCTL
),
